            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="image" name="image" class="form-control" value="{{ old('image') }}" multiple>
                    ...
                    <div class="form-group">
                        ...
                        <label id="category_id-error" class="error" for="category_id" style="display: none;color:red">Vui lòng nhập
